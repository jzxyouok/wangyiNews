...
//        [data writeToFile:[NSString stringWithFormat:@"/Users/张战威/Desktop/imag%d.png",i]atomically:YES];
    }
...
+ (UIImage *)blurryImage:(UIImage *)image{
    ...
    outRGBBuffer.height = CGImageGetHeight(img); outRGBBuffer.rowBytes = 3;
